...
/// <summary>
/// Persistence configuration for a Pronto service host. Bound from the <c>Persistence</c>
/// config section (env <c>Persistence__Provider</c>, <c>Persistence__CosmosEndpoint</c>,
/// <c>Persistence__DatabaseName</c>). Mirrors Pronto.BillerExperience.Api's provider toggle.
/// </summary>
