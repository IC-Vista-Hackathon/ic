import { StrictMode } from 'react'; import { createRoot } from 'react-dom/client'; import { App } from './App'; import { ErrorBoundary } from './ErrorBoundary'; import { initBrowserTelemetry, trackEvent } from './insights'; import { logError } from './telemetry'; import './styles.css';
